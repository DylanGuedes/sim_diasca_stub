...
:Organisation: Copyright (C) 2008-2016 EDF R&D
:Creation Date: February 2009
:Lastly Updated on: Thursday, June 9, 2016
...
.. Note::
 ...
 However we require internally that the authors of any simulation element making use of Sim-Diasca's services (ex: models, simulation cases, etc.) respect these conventions presented in the current document - for clarity and homogeneity.
