...
get_main_datalogger() ->
	...
	try basic_utils:wait_for_global_registration_of(
		...
		_Exception ->
			...
			sim_diasca:notify_hint( "The main data-logger could not be found, "
...
create_virtual_probe( ProbeName, CurveEntries, ZoneEntries, Title, XLabel,
	...
	% data-logger is not enabled, the actor creation time-out will trigger
	% before the one for the look-up of the data-logger.
	%
